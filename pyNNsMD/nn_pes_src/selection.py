...
from pyNNsMD.scaler.energy import EnergyGradientStandardScaler, EnergyStandardScaler, GradientStandardScaler, MaskedEnergyGradientStandardScaler
...
def get_default_scaler(model_type):
    ...
    if model_type == 'mlp_e':
        ...
        return MaskedEnergyGradientStandardScaler()
