...
from pyNNsMD.utils.loss import get_lr_metric, ScaledMeanAbsoluteError, r2_metric, ZeroEmptyLoss, mask_MeanSquaredError, MaskedScaledMeanAbsoluteError, masked_r2_metric
...
def train_model_energy_gradient(i=0, outdir=None, mode='training'):
    ...
    if energies_only:
        ...
        train_loss = {'energy': 'mean_squared_error', 'force': mask_MeanSquaredError}
